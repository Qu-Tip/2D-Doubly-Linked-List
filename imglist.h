/**
 *  @file        imglist.h
 *  @description Definition of a ImgList class, for CPSC 221 PA1
 *
 *  THIS FILE WILL NOT BE SUBMITTED.
 *  YOU MAY ADD YOUR OWN PRIVATE MEMBER FUNCTION DECLARATIONS IN imglist-private.h
 */
...
class ImgList {
    ...
    public:
        ...
        ~ImgList(); // destructor deallocates all heap data associated with this list
