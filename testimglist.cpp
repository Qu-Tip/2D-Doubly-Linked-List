 ...
 *  @description Contains basic tests for ImgList class, CPSC 221 PA1
 *               You are recommended to add to or modify these test cases with your own code.
 *
...
void TestCarveMode0() {
    ...
    if (inimg.height() == 6 && inimg.width() == 5) {
        ...
        cout << "Writing output PNG to 5x6-c_1_0-r_0_0.png... ";
        ...
        cout << "Writing output PNG to5x6-c_1_0-r_1_0.png... ";
        ...
        cout << "Writing output PNG to 5x6-c_2_0-r_0_0.png... ";
...
void TestRenderMode2() {
    ...
    if (inimg.height() == 6 && inimg.width() == 6) {
        ...
        cout << "Writing output PNG to 6x6-c_12_0-r_0_0.png... ";
        ...
        cout << "Writing output PNG to 6x6-c_12_0-r_1_2.png... ";
